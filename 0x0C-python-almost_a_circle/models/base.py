#!/usr/bin/python3
"""Start define a base model class."""
import json
import csv
import turtle
...
class Base:
    ...
    def from_json_string(json_string):
        """start the deserialization of a JSON string.
        Args:
            json_string (str): A JSON str representation of a list of dicts.
        Returns:
            If json_string is None or empty - an empty list.
            Or the Python list represented by json_string.
        """
    ...
    def load_from_file_csv(cls):
        """Return a list of classes instantiated from the CSV file.
    ...
    def draw(list_rectangles, list_squares):
        """Draw Rects and Squares using the turtle module.
        Args:
