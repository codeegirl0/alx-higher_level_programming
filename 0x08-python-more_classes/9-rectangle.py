...
class Rectangle:
    ...
    def __str__(self):
        """Ret an informal and nicely printable string representation
    ...
    def __repr__(self):
        """Ret a string representation of a Rectangle instance
        that is aaable to recreate a new instance by using eval()
        """
        return "Rectangle({}, {})".format(self.__width, self.__height)

    def __del__(self):
        """Del a Rectangle instance."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
    ...
    def bigger_or_equal(rect_1, rect_2):
        """look the biggest Rectangle based on the area
    ...
    def square(cls, size=0):
        """make a new Rectangle instance with width == height == size
